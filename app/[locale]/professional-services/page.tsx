...
const PRIORITY_CAPS = ['Local SEO', 'Reviews', 'Listings', 'Campaigns', 'Social media']
...
export default async function ProfessionalServicesPage({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* Why it matters — professional services-specific */}
      <section style={{ padding: 'clamp(48px, 6vw, 72px) 24px', background: C.pp }}>
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          <FadeIn style={{ marginBottom: 40 }}>
            ...
            >
              Your new clients search online before they ever ask for a referral.
            </h2>
            <p
              style={{
                fontFamily: sn,
            ...
            >
              Referrals still matter. But 63% of people searching for an accountant or solicitor
              check Google reviews before making contact. Karl makes sure you appear, you look
              credible, and you respond — so by the time they call, the decision is already made.
            </p>
          </FadeIn>
        ...
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          <FadeIn style={{ marginBottom: 8 }}>
            ...
            <p style={{ fontFamily: sn, fontSize: 14, color: C.mid, marginTop: 6 }}>
              One new client from Karl pays for six months of subscription.
            </p>
          </FadeIn>
          <PricingSection
