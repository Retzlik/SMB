...
const PRIORITY_CAPS = ['Reviews', 'Local SEO', 'Listings', 'AI Receptionist', 'Google Ads']
...
export default async function AutomotivePage({ params }: Props) {
  const { locale } = await params
  const t = await getTranslations({ locale, namespace: 'AutomotivePage' })
    ...
    <>
      ...
      >
        ...
        >
          ...
          {[t('subverticals.0'), t('subverticals.1'), t('subverticals.2')].map((sv) => (
      ...
      {/* Why it matters — automotive specific */}
      <section style={{ padding: 'clamp(48px, 6vw, 72px) 24px', background: C.pp }}>
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          <FadeIn style={{ marginBottom: 40 }}>
            ...
            >
              In automotive, rank and reputation are everything.
            </h2>
            <p
              style={{
                fontFamily: sn,
            ...
            >
              When someone searches "Fahrschule Berlin" or "garage near me," the top three results
              get 75% of all clicks. Karl makes sure you're one of them — optimising your Google
              Business Profile, keeping your listing accurate on every directory, and building a
              review count that signals trust before they ever contact you.
            </p>
          </FadeIn>
        ...
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          <FadeIn style={{ marginBottom: 8 }}>
            ...
            <p style={{ fontFamily: sn, fontSize: 14, color: C.mid, marginTop: 6 }}>
              One extra student from search covers your subscription for three months.
            </p>
          </FadeIn>
          <PricingSection
